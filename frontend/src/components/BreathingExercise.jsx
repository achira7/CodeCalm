  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-between">
        <h1
          className={`flex items-center justify-between text-3xl font-bold text-sky-500 font-google m-5 ${Color.background} ${Color.cardBGText} `}
        >
          Breathing Exercise
        </h1>
      </div>
      ...
      <div
        className={`flex pt-5 pb-10 flex-col items-center justify-center min-h-screen ${Color.background}`}
      >
        <div className={`w-full  lg:w-2/3 rounded-xl ${Color.breathingEx} `}>
          <div className="flex justify-between px-10 pt-10">
            <div>
              <p className={`text-2xl font-semibold ${Color.breathTitle} `}>
          ...
          <div
            className={`mx-10 my-8 py-10 border rounded-xl ${Color.breathBox} `}
          >
        ...
        <div
          className={` ${Color.breathInfo} w-full lg:w-2/3 mt-10 rounded-2xl flex flex-col lg:flex-row p-2`}
        >
          <div className="flex justify-center items-center">
            <img
              src={`http://127.0.0.1:8000/media/breathing/breath.png`}
