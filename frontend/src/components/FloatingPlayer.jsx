...
const FloatingPlayer = () => {
  ...
  const floatMode = 'fixed bottom-2 left-2 border border-gray-300 border-3 bg-opacity-60 backdrop-blur-sm '
  ...
  return (
    <div className={`${player.isFloating ? "" : window.location.pathname.includes('/employee/player') ? `flex justify-center   ${Color.background}` : '' }`}>
    ...
    <div
      ...
      className={` bg-opacity-30 ${
        ...
        player.isFloating ? floatMode : window.location.pathname.includes('/employee/player') ? normalMode : 'hidden'
      }`}
    >
